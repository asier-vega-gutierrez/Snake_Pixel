...
int Window::set_box_grid(int x, int y, int type) {
    Cell cell(x, y, type);
...
GLfloat* Window::generate_box(float offsetX, float offsetY) {
...
std::vector<GLfloat> Window::generate_grid_boxes_vertices(int selectedType) {
